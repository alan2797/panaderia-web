...
@section ('contenido')
	<div class="row">
      ...
      {!!Form::open(array('url'=>'usuario/proveedor','method'=>'POST',
        'autocomplete'=>'off','onsubmit'=>'return validar(this)','name'=>'formV'))!!}
            ...
            <div class="form-group">
              ...
              <select name="tipodocumento" id="tipodocumento" class="form-control">
                  ...
                  <label id="lbltipodocumento" style="display:none;color:red;">Nombre requirido</label>
            </div>
            </div>
              <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
            	<label for="Numero">Numero de Documento</label>
            	<input type="text" name="numero_documento" id="numero_documento" class="form-control" placeholder="numero...">
              <label id="lblnumero_documento" style="display:none;color:red;">Nombre requirido</label>
            </div>
              </div>
             <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            ...
            <div class="form-group">
              ...
              <label id="lbldireccion" style="display:none;color:red;">Nombre requirido</label>
            </div>
            </div>
               <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
              ...
              <select name="tipoempleado" id="tipoempleado" class="form-control">
                  ...
                  <label id="lbltipoempleado" style="display:none;color:red;">Nombre requirido</label>
            </div>
            </div>
             <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                  ...
                  <label id="lbltelefono" style="display:none;color:red;">Nombre requirido</label>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
            <div class="form-group">
                  ...
                  <label id="lblemail" style="display:none;color:red;">Nombre requirido</label>
                </div>
            </div>
            <div class="form-group">
