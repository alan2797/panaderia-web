...
@section ('contenido')
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      {!!Form::open(array('url'=>'ventas/venta','method'=>'POST',
        'autocomplete'=>'off','onsubmit'=>'return validar(this)','name'=>'formV'))!!}
            ...
            <div class="form-group">
              ...
              <input type="text" name="num_comprobante" id="num_comprobante" value="{{old('num_comprobante')}}" class="form-control" placeholder="numero...">
              <label id="lblnum_comprobante" style="display:none;color:red;">Numero De Comprobante requirido</label>
            </div>
             </div>
              </div>
            <div class="row">
  ...
  function validar(e){
        console.log("validando")
                ...
                //expresionTelefono = /\/;  
        var num_comprobante = document.getElementById('num_comprobante');
        var lblnum_comprobante= document.getElementById('lblnum_comprobante');
        lblnum_comprobante.setAttribute("style", "display: none;");
         
        var bool = true;
		  if (!/^([0-9])*$/.test(num_comprobante.value) || num_comprobante.value.length== 0) {
        lblnum_comprobante.setAttribute("style", "display: initial;color:red;");
              //alert('Rellena el campo nomnbre');
              if(bool){
                  document.formV.num_comprobante.focus() 
                  bool = false;
              }
		  }
          return bool;
